...
import com.ice.eco.fishin.data.database.EcoDao
import com.ice.eco.fishin.data.database.GoalEntity
import com.ice.eco.fishin.data.database.HabitEntity
import com.ice.eco.fishin.data.database.WasteEntity
import com.ice.eco.fishin.data.store.EcoPreferences
    ...
    init {
        ...
        viewModelScope.launch {
            if (dao.getHabits().first().isEmpty()) {
                dao.insertHabit(HabitEntity(name = "No Meat Today"))
                dao.insertHabit(HabitEntity(name = "Zero Plastic Used"))
                dao.insertHabit(HabitEntity(name = "Biked to Work"))
                dao.insertHabit(HabitEntity(name = "Used Reusable Bags"))
                dao.insertHabit(HabitEntity(name = "Took a Short Shower"))
                dao.insertHabit(HabitEntity(name = "Turned Off Unused Lights"))
                dao.insertHabit(HabitEntity(name = "Composted Food Scraps"))
            }
